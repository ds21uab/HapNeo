## ============================================================================
## discovery_cox_ewas.R
## Multivariate Cox regression GWAS on the Discovery cohort
## Tests association between each germline variant and overall survival,
## adjusting for age, sex, batch, and population ancestry (PC1-PC5)
## ============================================================================
##
## HPC REQUIREMENT: This script requires significant memory and benefits
## from parallel processing. Example SLURM allocation:
##   srun --ntasks=2 --time=05:00:00 --mem-per-cpu=100G \
##        --partition=short --job-name=cox_gwas --pty /bin/bash
##
## INPUT FILES (controlled access — not included in repository):
...
##
## OUTPUT:
##   - results/gwas_discovery_results.csv
##
...
fwrite(res_discovery, file = "results/gwas_discovery_results.csv",
       sep = ",", quote = FALSE, col.names = TRUE)
fwrite(sig_snps, file = "results/gwas_discovery_significant.csv",
       sep = ",", quote = FALSE, col.names = TRUE)
